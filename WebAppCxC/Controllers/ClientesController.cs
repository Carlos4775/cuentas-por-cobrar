...
namespace WebAppCxC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_cliente,Nombre_cliente,Cedula,LimiteCredito,Estado")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_cliente,Nombre_cliente,Cedula,LimiteCredito,Estado")] Cliente cliente)
        {
