...
namespace WebAppCxC.Controllers
{
    public class BalancesController : Controller
    {
        ...
        public ActionResult Index(string Criterio = null)
        {
            ...
            return View(db.Balances.Where(p => Criterio == null || p.Cliente.Nombre_cliente.StartsWith(Criterio) ||
        ...
        public ActionResult Create([Bind(Include = "Id_balance,Id_cliente,Fecha_corte,Antiguedad_promedio_saldos,Monto")] Balance balance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_balance,Id_cliente,Fecha_corte,Antiguedad_promedio_saldos,Monto")] Balance balance)
        {
            if (ModelState.IsValid)
            {
