...
namespace WebAppCxC.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        public ActionResult Index(string Criterio = null)
        {
            ...
            p.Numero_documento.ToString().StartsWith(Criterio) || p.Clientes.Nombre_cliente.StartsWith(Criterio) ||
        ...
        public ActionResult Details(int? id)
        {
            ...
            Transacciones transaccione = db.Transacciones.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id_transaccion,Tipo_movimiento,Id_tipoDocumento,Numero_documento,Fecha,Id_cliente,Monto")] Transacciones transaccione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_transaccion,Tipo_movimiento,Id_tipoDocumento,Numero_documento,Fecha,Id_cliente,Monto")] Transacciones transaccione)
        {
